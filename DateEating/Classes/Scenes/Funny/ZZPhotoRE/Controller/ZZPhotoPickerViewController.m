...
-(UILabel *)totalNumLabel{
    if (!_totalNumLabel) {
        _totalNumLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 64, ZZ_VW, 20)];
...
-(void)setupCollectionViewUI
{
    ...
    _picsCollection = [[UICollectionView alloc]initWithFrame:CGRectMake(0,100,kScreenWidth-64 , kScreenHeight) collectionViewLayout:flowLayout];
    ...
    NSLayoutConstraint *pic_top = [NSLayoutConstraint constraintWithItem:self.view attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:_picsCollection attribute:NSLayoutAttributeTop multiplier:1 constant:-100.0f];

...
#define HotRequest_Url(city,multi,gender,time,age,constellation,occupation,start) [NSString stringWithFormat:@"http://api.qingchifan.com/api/event/city.json?access_token=6916a7ab1f71e43ac4eadf40a51b4ab16CBEB96E84AF9926E7406CC46FF121FD&basicCheck=0&city=%@&multi=%ld&gender=%ld&time=%ld&age=%ld&constellation=%ld&occupation=%ld&start=%ld&size=20&apiVersion=2.9.0",city,multi,gender,time,age,constellation,occupation,start]

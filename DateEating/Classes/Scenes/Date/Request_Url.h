...
#define HotRequest_Url(city,multi,gender,time,age,constellation,occupation,start) [NSString stringWithFormat:@"http://api.qingchifan.com/api/event/city.json?access_token=6916a7ab1f71e43ac4eadf40a51b4ab16CBEB96E84AF9926E7406CC46FF121FD&basicCheck=0&city=%ld&multi=%ld&gender=%ld&time=%ld&age=%ld&constellation=%ld&occupation=%ld&start=%ld&size=20&apiVersion=2.9.0",city,multi,gender,time,age,constellation,occupation,start]
...
// 评论信息的链接
#define ChatMessageRequest_Url(eventId,start) [NSString stringWithFormat:@"http://api.qingchifan.com/api/event/comments.json?access_token=6916a7ab1f71e43ac4eadf40a51b4ab1AD09063BB2436532A103098481B9ADF2&basicCheck=0&eventId=%ld&start=%ld&size=50",eventId,start]
...
// 个人信息详情链接
#define UserDetailRequest_Url(userId) [NSString stringWithFormat:@"http://api.qingchifan.com/api/user/v2/getUserBusinessInfo.json?access_token=6916a7ab1f71e43ac4eadf40a51b4ab1AD09063BB2436532A103098481B9ADF2&visitUserId=%ld",userId]
